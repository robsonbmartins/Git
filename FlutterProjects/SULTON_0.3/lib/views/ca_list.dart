...
class CAList extends StatefulWidget {
  CAList({Key key}) : super(key: key);
  @override
  _CAListState createState() => _CAListState();
}

class _CAListState extends State<CAList> {
  @override
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            Center(
              ...
              child: Text('Encerrar a Sessão ${authService.user.displayName}'),
            )),
            IconButton(
                icon: Icon(Icons.add),
                onPressed: () {
